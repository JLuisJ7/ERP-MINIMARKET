...
--
-- Create schema db_sismima
--

CREATE DATABASE IF NOT EXISTS db_sismima;
USE db_sismima;

--
-- Definition of table `admcatalogo`
--

DROP TABLE IF EXISTS `admcatalogo`;
...
--
-- Dumping data for table `admcatalogo`
--

/*!40000 ALTER TABLE `admcatalogo` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `admcatalogo` ENABLE KEYS */;


--
-- Definition of table `admgrcatalogo`
--

DROP TABLE IF EXISTS `admgrcatalogo`;
...
--
-- Dumping data for table `admgrcatalogo`
--

/*!40000 ALTER TABLE `admgrcatalogo` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `admgrcatalogo` ENABLE KEYS */;


--
-- Definition of table `admopcion`
--

DROP TABLE IF EXISTS `admopcion`;
...
--
-- Dumping data for table `admopcion`
--

/*!40000 ALTER TABLE `admopcion` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `admopcion` ENABLE KEYS */;


--
-- Definition of table `admrol`
--

DROP TABLE IF EXISTS `admrol`;
CREATE TABLE `admrol` (
...
--
-- Dumping data for table `admrol`
--

/*!40000 ALTER TABLE `admrol` DISABLE KEYS */;
INSERT INTO `admrol` (`ide_rol`,`des_nombre`) VALUES 
 (1,'ADMINISTRADOR'),
 (2,'GERENTE DE VENTAS'),
 (3,'VENDEDOR'),
 (4,'GERENTE DE COMPRAS');
/*!40000 ALTER TABLE `admrol` ENABLE KEYS */;


--
-- Definition of table `admrolopcion`
--

DROP TABLE IF EXISTS `admrolopcion`;
...
--
-- Dumping data for table `admrolopcion`
--

/*!40000 ALTER TABLE `admrolopcion` DISABLE KEYS */;
/*!40000 ALTER TABLE `admrolopcion` ENABLE KEYS */;


--
-- Definition of table `sisdepartamento`
--

DROP TABLE IF EXISTS `sisdepartamento`;
CREATE TABLE `sisdepartamento` (
  `ide_departamento` char(2) NOT NULL,
  `des_nombre` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sisdepartamento`
--

/*!40000 ALTER TABLE `sisdepartamento` DISABLE KEYS */;
INSERT INTO `sisdepartamento` (`ide_departamento`,`des_nombre`) VALUES 
 ...
 ('24','TUMBES'),
 ('25','UCAYALI');
/*!40000 ALTER TABLE `sisdepartamento` ENABLE KEYS */;


--
-- Definition of table `sisdireccion`
--

DROP TABLE IF EXISTS `sisdireccion`;
CREATE TABLE `sisdireccion` (
  `ide_direccion` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sisdireccion`
--

/*!40000 ALTER TABLE `sisdireccion` DISABLE KEYS */;
/*!40000 ALTER TABLE `sisdireccion` ENABLE KEYS */;


--
-- Definition of table `sisdistrito`
--

DROP TABLE IF EXISTS `sisdistrito`;
CREATE TABLE `sisdistrito` (
  `ide_departamento` char(2) NOT NULL,
...
--
-- Dumping data for table `sisdistrito`
--

/*!40000 ALTER TABLE `sisdistrito` DISABLE KEYS */;
INSERT INTO `sisdistrito` (`ide_departamento`,`ide_provincia`,`ide_distrito`,`des_nombre`) VALUES 
 ...
 ('25','03','03','CURIMANA'),
 ('25','04','01','PURUS');
/*!40000 ALTER TABLE `sisdistrito` ENABLE KEYS */;


--
-- Definition of table `sispersona`
--

DROP TABLE IF EXISTS `sispersona`;
CREATE TABLE `sispersona` (
  ...
  `fec_nacimiento` varchar(45) DEFAULT NULL,
  `ide_estado` char(1) NOT NULL,
  PRIMARY KEY (`ide_persona`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sispersona`
--

/*!40000 ALTER TABLE `sispersona` DISABLE KEYS */;
INSERT INTO `sispersona` (`ide_persona`,`des_nombres`,`des_apepat`,`des_apemat`,`des_razonsocial`,`nro_documento`,`ide_tipodocumento`,`des_telefono`,`des_correo`,`ide_tipopersona`,`ide_condicion`,`ide_sexo`,`ide_estcivil`,`fec_nacimiento`,`ide_estado`) VALUES 
 (1,'LIZANDRO','ALIPAZAGA','COLLANTES','','44305724',10,'972620265','i_sonny@hotmail.com',12,17,21,24,'1987-06-03 00:00:00','1'),
 (2,'MARIELA','ESPINOZA','OLIVOS',NULL,'44417336',10,'947236548','marielae@hotmail.com',12,17,22,24,'1987-06-01 00:00:00','1'),
 (3,'ERICK','FITZCARRALD','ALIPAZAGA',NULL,'45258793',10,'978545325','erickfz@hotmail.com',12,18,21,24,'1987-09-18 00:00:00','0'),
 (4,'ENRIQUE','FIGUEROA','RODRIGUEZ',NULL,'46258965',10,'925468624','efigueroa@gmail.com',12,18,21,23,'1987-05-03 00:00:00','1'),
 (5,NULL,NULL,NULL,'DISTRIBUIDORA EL CHANCAYANO','20181654789',14,'3771654',NULL,13,19,NULL,NULL,'','1'),
 (6,'JOSE LUIS','MANDUJANO','BUENO',NULL,'42568974',10,'4528967','jmandujano@hotmail.com',12,18,21,23,'1987-04-28 00:00:00','1'),
 (7,'EMILIANO','MALLQUI','AGUILAR',NULL,'06242471',10,'971945325','emiliano@gmail.com',12,18,21,23,'1980-02-18 00:00:00','1'),
 (8,'EUSEBIO','AGUILAR','CALDERON',NULL,'19817929',10,'972665965','eusebio458@gmail.com',12,18,21,24,'1982-06-23 00:00:00','1'),
 (9,'LEONELA','ESPINOZA','AVILA',NULL,'15201863',10,'972610665','leonela789@gmail.com',12,18,22,23,'1986-12-14 00:00:00','1'),
 (10,'JOAQUIN','PACCO','HUAMAN',NULL,'20963858',10,'977020265','joaquinrt45@gmail.com',12,18,21,23,'1981-11-10 00:00:00','1'),
 (11,'ELEUTERIO','LAZARO','PAITAN',NULL,'19910024',10,'978545730','eleuterio4587@gmail.com',12,18,21,24,'1980-12-18 00:00:00','1'),
 (12,'JULIA CUNCA','BRAVO','LAURA',NULL,'19993743',10,'972830265','julia.cunca@gmail.com',12,18,22,23,'1983-03-14 00:00:00','1'),
 (13,'JULIA','CHAVEZ','FERNANDEZ',NULL,'25462984',10,'974925325','julia4789@gmail.com',12,18,22,23,'1985-09-17 00:00:00','1');
/*!40000 ALTER TABLE `sispersona` ENABLE KEYS */;


--
-- Definition of table `sisprovincia`
--

DROP TABLE IF EXISTS `sisprovincia`;
CREATE TABLE `sisprovincia` (
  `ide_departamento` char(2) NOT NULL,
  `ide_provincia` char(2) NOT NULL,
  `des_nombre` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `sisprovincia`
--

/*!40000 ALTER TABLE `sisprovincia` DISABLE KEYS */;
INSERT INTO `sisprovincia` (`ide_departamento`,`ide_provincia`,`des_nombre`) VALUES 
 ...
 ('25','03','PADRE ABAD'),
 ('25','04','PURUS');
/*!40000 ALTER TABLE `sisprovincia` ENABLE KEYS */;


--
-- Definition of table `sisusuario`
--

DROP TABLE IF EXISTS `sisusuario`;
...
--
-- Dumping data for table `sisusuario`
--

/*!40000 ALTER TABLE `sisusuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `sisusuario` ENABLE KEYS */;


--
-- Definition of table `sisvia`
--

DROP TABLE IF EXISTS `sisvia`;
CREATE TABLE `sisvia` (
  `ide_via` char(2) NOT NULL,
...
--
-- Dumping data for table `sisvia`
--

/*!40000 ALTER TABLE `sisvia` DISABLE KEYS */;
INSERT INTO `sisvia` (`ide_via`,`des_nombre`) VALUES 
 ...
 ('10','CARRETERA'),
 ('11','BLOCK');
/*!40000 ALTER TABLE `sisvia` ENABLE KEYS */;


--
-- Definition of table `siszona`
--

DROP TABLE IF EXISTS `siszona`;
CREATE TABLE `siszona` (
  `ide_zona` char(2) NOT NULL,
  `des_abrev` varchar(5) NOT NULL,
  `des_nombre` varchar(50) NOT NULL,
  PRIMARY KEY (`ide_zona`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `siszona`
--

/*!40000 ALTER TABLE `siszona` DISABLE KEYS */;
INSERT INTO `siszona` (`ide_zona`,`des_abrev`,`des_nombre`) VALUES 
 ...
 ('10','CAS.','CASERÍO'),
 ('11','FND.','FUNDO');
/*!40000 ALTER TABLE `siszona` ENABLE KEYS */;
