...
--
-- Servidor: localhost
-- Tiempo de generación: 06-06-2015 a las 01:41:20
...
--
-- Volcar la base de datos para la tabla `admcatalogo`
--
...
--
-- Volcar la base de datos para la tabla `admgrcatalogo`
--
...
--
-- Volcar la base de datos para la tabla `admopcion`
--
...
(2, 2, 'Boletas', 'ventas/boletas', 1, '1', 'lalipazaga@sismima.com', '2015-04-18 22:07:13', NULL, NULL, '', 0),
...
--
-- Volcar la base de datos para la tabla `admrol`
--
...
--
-- Volcar la base de datos para la tabla `admrolopcion`
--
...
CREATE TABLE IF NOT EXISTS `boleta` (
  ...
  PRIMARY KEY (`nroSerie`,`nroBol`),
  KEY `fk_Bol_Cli` (`idCliente`)
...
('001', 1, 13, 1, '2015-05-27 22:55:04', '9.00', '1', NULL),
('001', 2, 29, 1, '2015-05-27 23:01:35', '10.50', '1', NULL);
...
(5, 'ANA MARCIA LOZANO', '0', '10214578421', 'SALAVERRY 55', '965454214', 'IWDKW@gmail.com', '2015-05-18 15:17:14', '1'),
(6, 'JUAN CARRASCO VALDES', '1', '10421325412', 'ATE VITARTE', '654512587', 'JUAN_54@gmail.com', '2015-05-18 15:17:14', '0'),
(7, 'comercial DOÃ‘A MARIANA', '1', '20441245778', 'Av ZARATE 845', '956412584', 'MARIARIKA@gmail.com', '2015-05-18 15:17:14', '0'),
...
(14, 'COMERCIAL CONTRERAZ', '1', '20475123654', 'Av carlos izaguirre', '954687542', 'COMERCIALCONTRERAZ@gmail.com', '2015-05-18 15:17:14', '1'),
...
CREATE TABLE IF NOT EXISTS `detalleboleta` (
  ...
  KEY `fk_Bol_detFac` (`nroSerie`,`nroBol`),
  KEY `fk_DetBol_Prod` (`idProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcar la base de datos para la tabla `detalleboleta`
--
...
CREATE TABLE IF NOT EXISTS `detallefactura` (
  ...
  `cantidad` int(10) unsigned NOT NULL,
  `precio` decimal(8,2) NOT NULL,
  KEY `fk_Fac_detFac` (`nroSerie`,`nroFact`),
  KEY `fk_DetFac_Prod` (`idProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- (Evento) desencadenante `detallefactura`
--
...
CREATE TABLE IF NOT EXISTS `detalleordencompra` (
  ...
  `cantidad` int(10) unsigned NOT NULL,
  `precio` decimal(8,2) NOT NULL,
  KEY `fk_ord_detord` (`nroSerie`,`nroOrden`),
  KEY `fk_Detord_Prod` (`idProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- (Evento) desencadenante `detalleordencompra`
--
DROP TRIGGER IF EXISTS `ActualizarStockCompra`;
DELIMITER //
...
(1, 'Ayala', 'Benito', 'Jose Luis', '1996-06-07', '71886624', '944659233', 'M', '2015-05-24 08:26:06', '1');
...
CREATE TABLE IF NOT EXISTS `factura` (
  ...
  `estadoFact` char(1) DEFAULT '1',
  `fechaElim` date DEFAULT NULL,
  PRIMARY KEY (`nroSerie`,`nroFact`),
  KEY `fk_Fac_Cli` (`idCliente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('001', 7, 13, 1, '2015-05-25 21:52:50', '46.00', '8.28', '54.28', '1', NULL),
('001', 8, 29, 1, '2015-05-25 21:57:00', '39.00', '7.02', '46.02', '1', NULL),
('001', 9, 13, 1, '2015-05-25 21:58:29', '29.00', '5.22', '34.22', '1', NULL),
('001', 10, 5, 1, '2015-05-25 22:00:02', '2.00', '0.36', '2.36', '1', NULL),
('001', 11, 29, 1, '2015-05-25 22:08:08', '6.00', '1.08', '7.08', '1', NULL),
('001', 12, 29, 1, '2015-05-25 22:18:06', '8.50', '1.53', '10.03', '1', NULL),
('001', 13, 5, 1, '2015-05-26 06:58:24', '16.00', '2.88', '18.88', '1', NULL),
('001', 14, 29, 1, '2015-05-26 06:59:55', '12.00', '2.16', '14.16', '1', NULL),
...
(17, '2', '001', 4, '2015-05-25 06:51:08', 'E', 1, 100, '2.00', '200.00'),
(18, '2', '001', 4, '2015-05-25 06:51:08', 'E', 20, 50, '5.00', '250.00'),
(19, '2', '001', 4, '2015-05-25 06:51:08', 'E', 32, 15, '5.00', '75.00'),
(20, '2', '001', 5, '2015-05-25 08:35:04', 'E', 2, 5, '5.00', '25.00'),
(21, '2', '001', 6, '2015-05-25 08:35:25', 'E', 4, 5, '1.50', '7.50'),
(22, '2', '001', 6, '2015-05-25 08:35:25', 'E', 3, 4, '3.00', '12.00'),
(23, '2', '001', 7, '2015-05-25 09:22:00', 'E', 8, 10, '5.00', '50.00'),
(24, '2', '001', 7, '2015-05-25 09:22:00', 'E', 15, 25, '3.00', '75.00'),
(25, '2', '001', 8, '2015-05-25 19:20:29', 'E', 2, 6, '5.00', '30.00'),
(26, '2', '001', 8, '2015-05-25 19:20:31', 'E', 12, 6, '5.00', '30.00'),
(27, '2', '001', 8, '2015-05-25 19:20:31', 'E', 32, 8, '5.00', '40.00'),
(28, '2', '001', 9, '2015-05-25 19:28:43', 'E', 22, 10, '1.50', '15.00'),
(29, '2', '001', 9, '2015-05-25 19:28:43', 'E', 20, 5, '5.00', '25.00'),
(30, '2', '001', 10, '2015-05-25 19:55:01', 'E', 4, 4, '1.50', '6.00'),
(31, '2', '001', 10, '2015-05-25 19:55:01', 'E', 7, 5, '2.00', '10.00'),
(32, '2', '001', 10, '2015-05-25 19:55:02', 'E', 29, 5, '3.00', '15.00'),
(33, '2', '001', 11, '2015-05-25 20:07:11', 'E', 20, 8, '5.00', '40.00'),
(34, '2', '001', 11, '2015-05-25 20:07:11', 'E', 17, 6, '3.00', '18.00'),
(35, '2', '001', 12, '2015-05-25 20:26:36', 'E', 4, 10, '1.50', '15.00'),
(36, '2', '001', 12, '2015-05-25 20:26:36', 'E', 17, 5, '3.00', '15.00'),
(37, '2', '001', 12, '2015-05-25 20:26:36', 'E', 13, 3, '3.00', '9.00'),
(38, '2', '001', 13, '2015-05-25 20:29:34', 'E', 17, 10, '3.00', '30.00'),
(39, '2', '001', 13, '2015-05-25 20:29:34', 'E', 22, 5, '1.50', '7.50'),
(40, '1', '001', 8, '2015-05-25 21:57:01', 'S', 2, 6, '5.00', '30.00'),
(41, '1', '001', 8, '2015-05-25 21:57:01', 'S', 3, 3, '3.00', '9.00'),
(42, '1', '001', 10, '2015-05-25 22:00:02', 'S', 1, 1, '2.00', '2.00'),
(43, '1', '001', 11, '2015-05-25 22:08:08', 'S', 1, 1, '2.00', '2.00'),
(44, '1', '001', 11, '2015-05-25 22:08:09', 'S', 6, 1, '2.00', '2.00'),
(45, '1', '001', 11, '2015-05-25 22:08:09', 'S', 7, 1, '2.00', '2.00'),
(46, '2', '001', 14, '2015-05-25 22:17:48', 'E', 4, 8, '1.50', '12.00'),
(47, '2', '001', 14, '2015-05-25 22:17:48', 'E', 7, 10, '2.00', '20.00'),
(48, '1', '001', 12, '2015-05-25 22:18:07', 'S', 1, 1, '2.00', '2.00'),
(49, '1', '001', 12, '2015-05-25 22:18:07', 'S', 2, 1, '5.00', '5.00'),
(50, '1', '001', 12, '2015-05-25 22:18:07', 'S', 4, 1, '1.50', '1.50'),
(51, '1', '001', 13, '2015-05-26 06:58:25', 'S', 1, 3, '2.00', '6.00'),
(52, '1', '001', 13, '2015-05-26 06:58:26', 'S', 2, 2, '5.00', '10.00'),
(53, '1', '001', 14, '2015-05-26 06:59:55', 'S', 1, 3, '2.00', '6.00'),
(54, '1', '001', 14, '2015-05-26 06:59:55', 'S', 3, 2, '3.00', '6.00'),
(55, '1', '001', 15, '2015-05-26 07:00:45', 'S', 15, 2, '3.00', '6.00'),
(56, '1', '001', 15, '2015-05-26 07:00:45', 'S', 16, 2, '5.00', '10.00'),
(57, '2', '001', 15, '2015-05-26 07:09:09', 'E', 2, 4, '5.00', '20.00'),
(58, '2', '001', 15, '2015-05-26 07:09:09', 'E', 5, 3, '2.00', '6.00'),
(59, '2', '001', 16, '2015-05-26 07:09:56', 'E', 4, 4, '1.50', '6.00'),
(60, '2', '001', 16, '2015-05-26 07:09:56', 'E', 7, 3, '2.00', '6.00'),
(61, '2', '001', 17, '2015-05-26 07:10:38', 'E', 7, 2, '2.00', '4.00'),
(62, '1', '001', 16, '2015-05-26 21:55:25', 'S', 1, 10, '2.00', '20.00'),
(63, '1', '001', 16, '2015-05-26 21:55:26', 'S', 2, 3, '5.00', '15.00'),
(64, '1', '001', 17, '2015-05-26 21:56:17', 'S', 1, 4, '2.00', '8.00'),
(65, '1', '001', 18, '2015-05-26 22:01:00', 'S', 2, 3, '5.00', '15.00'),
...
CREATE TABLE IF NOT EXISTS `ordencompra` (
  ...
  `fechaElim` date DEFAULT NULL,
  PRIMARY KEY (`nroSerie`,`nroOrden`),
  KEY `fk_ord_Prov` (`idProveedor`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('001', 4, 9, 1, '2015-05-25 06:51:08', '525.00', '94.50', '619.50', '1', NULL),
('001', 5, 3, 1, '2015-05-25 08:35:03', '25.00', '4.50', '29.50', '1', NULL),
('001', 6, NULL, 1, '2015-05-25 08:35:25', '19.50', '3.51', '23.01', '1', NULL),
('001', 7, 1, 1, '2015-05-25 09:21:58', '125.00', '22.50', '147.50', '1', NULL),
('001', 8, 1, 1, '2015-05-25 19:20:28', '100.00', '18.00', '118.00', '1', NULL),
('001', 9, 1, 1, '2015-05-25 19:28:43', '40.00', '7.20', '47.20', '1', NULL),
('001', 10, 1, 1, '2015-05-25 19:55:01', '31.00', '5.58', '36.58', '1', NULL),
('001', 11, 5, 1, '2015-05-25 20:06:45', '0.00', '0.00', '0.00', '1', NULL),
('001', 12, 1, 1, '2015-05-25 20:26:36', '39.00', '7.02', '46.02', '1', NULL),
('001', 13, 1, 1, '2015-05-25 20:29:34', '37.50', '6.75', '44.25', '1', NULL),
('001', 14, 1, 1, '2015-05-25 22:17:48', '32.00', '5.76', '37.76', '1', NULL),
('001', 15, 1, 1, '2015-05-26 07:09:09', '26.00', '4.68', '30.68', '1', NULL),
...
--
-- Volcar la base de datos para la tabla `parametrogeneral`
--
...
(16, 'Cerveza Klosterbier RhÃ¶nbrÃ¤u', 'Botella', 25, '1', 38, 3, 5, '2015-05-17 04:49:12', '1', '5.00'),
...
(24, 'oreo', 'bolsa', 1, '1', 30, 3, 2, '2015-05-17 04:49:12', '1', '5.00'),
(25, 'charada', 'bolsa', 16, '1', 94, 8, 2, '2015-05-17 04:49:12', '1', '3.00'),
(26, 'papa lays', 'lata', 1, '1', 144, 4, 6, '2015-05-17 04:49:12', '1', '1.50'),
(27, 'piqueo', 'Lata', 1, '0', 45, 1, 6, '2015-05-17 04:49:12', '1', '2.00'),
(28, 'pezidury', 'Botella', 1, '1', 36, 3, 1, '2015-05-17 04:49:12', '1', '5.00'),
(29, 'sevix', 'bolsa', 1, '1', 109, 8, 3, '2015-05-17 04:49:12', '1', '3.00'),
...
(17, 'DÂ´CARMEN S.A', '1', '20401455251', 'Av. Canada, Lince', '3655005', 'quimicasuiza@hotmail.com', '2015-05-17 03:04:04', '1'),
...
(30, 'Laive S.A', '1', '20100095450', 'Av. Nicolas De PiÃ©rola, Ate Vitarte', '996187600', 'laive@hotmail.com', '2015-05-17 03:04:04', '1'),
(31, 'LATINO ANDINA S.A.', '1', '20100041953', 'Av. Paseo de la RepÃºblica 3505, San Isidro', '994111000', 'rimacseguros@hotmail.com', '2015-05-17 03:04:04', '1'),
...
(35, 'LA LEÃ‘A S.A', '1', '20337564373', 'Av. La marina 2000, San Miguel', '995663569', 'riplay@hotmail.com', '2015-05-17 03:04:05', '1'),
...
--
-- Volcar la base de datos para la tabla `sispersona`
--
...
--
-- Volcar la base de datos para la tabla `sisusuario`
--
